...
if __name__ == '__main__':
    ...
    path = os.getcwd()
    print(path)
    # kjpeg.Compress("./liver_system/compression/result.bmp")
    src = cv2.imread("./liver_system/compression/123.jpg")
    cv2.imwrite('./liver_system/compression/12.jpg', src, [int(cv2.IMWRITE_JPEG_QUALITY), 70])
    # openjpeg.decode()
    # kjpeg.Decompress("./liver_system/compression/123.gpj")
